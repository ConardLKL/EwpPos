...
public abstract class DatabaseColumn implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "com.limahao.ticket.provider";
	/**
	 * The database's name
	 */
	public static final String DATABASE_NAME = "ticketApp.db";
	/**
	...
	public static final String[] SUBCLASSES = new String[] {
			"com.limahao.ticket.db.RequestCacheColumn",
			"com.limahao.ticket.db.PreDateColumn",
			"com.limahao.ticket.db.UserInfoColumn",
			"com.limahao.ticket.db.HistoryOrderColumn"};
