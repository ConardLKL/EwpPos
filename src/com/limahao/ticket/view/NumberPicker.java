...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDERS_DISTANCE = 45;
    ...
    private OnSelectedValueClickListener mOnSelectedValueClickListener;
    /**
     * 点击选中的数据，一般认为选择完毕，做退出处理
     */
    public interface OnSelectedValueClickListener {

      /**
       * 父view
       * @param parent
       */
        void OnSelectedValueClick();
    }
                ...
                if (Math.abs(initialVelocity) > mMinimumFlingVelocity) {
                    ...
                    if (deltaMoveY <= mTouchSlop) { // && deltaTime < ViewConfiguration.getTapTimeout()) {
                        if (mShowSoftInputOnTap) {
                            ...
                            showSoftInput();
                            // 点击选中的数据，一般认为选择完毕，做退出处理
                            if(mOnSelectedValueClickListener != null){
                            	mOnSelectedValueClickListener.OnSelectedValueClick();
                            }
                        } else {
     ...
     * 点击选中的数据，一般认为选择完毕，做退出处理
     */
    public void setOnSelectedValueClickListener(OnSelectedValueClickListener onSelectedValueClickListener) {
    	mOnSelectedValueClickListener = onSelectedValueClickListener;
    }
     ...
     *
     * @param mDateDisStrings1 The displayed values.
     *
     * <strong>Note:</strong> The length of the displayed values array
     ...
     * String[];
     */
    public void setDisplayedValues(ArrayList<String> mDateDisStrings1) {
        if (mDisplayedValues == mDateDisStrings1) {
            return;
        }
        mDisplayedValues = mDateDisStrings1;
        if (mDisplayedValues != null) {
    ...
    private boolean updateInputTextView() {
        ...
        String text = (mDisplayedValues == null) ? formatNumber(mValue)
                : mDisplayedValues.get(mValue - mMinValue);
        ...
        private String getVirtualDecrementButtonText() {
            ...
            if (value >= mMinValue) {
                return (mDisplayedValues == null) ? formatNumber(value)
                        : mDisplayedValues.get(value - mMinValue);
            }
            return null;
        }
