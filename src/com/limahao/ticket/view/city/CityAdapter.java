...
import com.limahao.ticket.view.city.PinnedHeaderListView.PinnedHeaderAdapter;
...
public class CityAdapter extends BaseAdapter implements SectionIndexer,
	...
	public CityAdapter(Context context, List<ItemCity> cities,
			Map<String, List<ItemCity>> map, List<String> sections,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int section = getSectionForPosition(position);
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.city_select_city_item, null);
		}
		...
		ItemCity item = mMap.get(mSections.get(section)).get(
				position - getPositionForSection(section));
		city.setText(item.getEndStation());
		return convertView;
	}
