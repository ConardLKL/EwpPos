package com.limahao.ticket.https;
...
//		String appCookie = mApp.getCookie();
//		DebugLog.d("请求phoneServer网络地址 " + url);
//		DebugLog.d("请求phoneServer网络地址时带上的：appCookie " + appCookie);
//		try {
//			StringEntity  se = new StringEntity(jsonParams); 
////			se.setContentType("Application/json");
////			se.setContentEncoding(CHARSET_UTF8);
//			HttpPost httpPost = new HttpPost(url);
//			httpPost.setHeader("Content-Type", "Application/json;charset=UTF-8");
//			// app标记
//			httpPost.setHeader(Configs.appSignKey, Configs.appSignValue);
////			httpPost.setHeader("Connection","Keep-Alive");
//			httpPost.setHeader("Cookie", appCookie);
//			//if(!Utility.isNullOrEmpty(jsonParams)) {
//				httpPost.setEntity(se);
//			//}
//			HttpClient client = getHttpClient(context);
//			// RFC2965定义了版本2并且尝试去弥补在版本1中Cookie的RFC2109标准的缺点
...
//            }
//            
//            DebugLog.d("请求phoneServer网络地址时返回的的：appCookie " + tmpcookies);
//            
//            //保存cookie
//	   		if(tmpcookies != null && tmpcookies != ""){
//	   			mApp.setCookie(tmpcookies);
//	   		}
//			
...
//	}
	...
	public static String getFromWebByHttpClient(Context context, String url,
			...
			DebugLog.d("getFromWebByHttpClient url = " + url);
		try {
			// http地址
			// String httpUrl =
