...
public class ConversationActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			layoutBack = (RelativeLayout) findViewById(R.id.umeng_left_layout);

			replyListView = (ListView) findViewById(R.id.umeng_fb_reply_list);
			// setListViewHeader(); 设置listview的头部
			...
			// findViewById((R.id.umeng_left_layout)).setOnClickListener(
			// new OnClickListener() {
			//
			// @Override
			// public void onClick(View v) {
	...
	class ReplyListAdapter extends BaseAdapter {
		...
		public ReplyListAdapter(Context context) {
			...
			//获取屏幕大小3/4作为宽度
			with = CommonUtil.getScreenWidth(ConversationActivity.this) / 4 * 3;
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 0) {
				// 自定义提示内容
				reply = createInitDevReply(getString(R.string.umeng_fb_reply_content_default));
			} else {
			...
			if (reply instanceof DevReply) {
				...
				layoutParams.rightMargin = 80; // 文字长度大于屏幕3/4时设置大小
				...
				layoutParams.leftMargin = 80; // 文字长度大于屏幕3/4时设置大小
				holder.replyContent.setLayoutParams(layoutParams);
				holder.replyContent
...
//			// 文字长度大于屏幕3/4时设置大小
//			if(holder.replyDate.getWidth() > with){
//				holder.replyDate.setWidth(with);
//			}
//			if(holder.replyContent.getWidth() > with){
//				holder.replyContent.setWidth(with);
//			}
